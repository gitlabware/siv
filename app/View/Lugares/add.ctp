<section role="main" id="main">
    ...
    <?php echo $this->Form->create('Lugare', array('id'=>'formID'));?>
        ...
        <div class="columns">
            ...
            <div class="new-row six-columns">
                ...
                <p class="block-label button-height">
                    ...
                    <?php echo $this->Form->text('nombre', array('class' => 'input full-width', 'placeholder' => 'Ingrese el nombre del lugar', 'value' => "")); ?>
                </p>
            </div>
