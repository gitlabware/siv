              ...
              <div id="areaImprimir">
                    ...
                    <thead>
                     <tr>
                        ...
                        <th colspan="4" style="text-align: center;">VENTAS</th>
                        <th rowspan="2">SALDO</th>
                       ...
                       'conditions'=>array(
                           'Productosprecio.producto_id'=>$idProducto, 
                    ...
                    <tbody>
                      <tr>
                        ...
                        $totalbs = 0;
                        $cantidadcolumnas =0;
                        foreach($precios as $val): //debug($val)?>
                        <td>
                        <?php 
