...
<section role="main" id="main">
    ...
    <hgroup id="main-title" class="thin">
        <h1>Reportes de etregas almacen central</h1>
    </hgroup>
    ...
    <div class="with-padding">   
        ...
        <?php echo $this->Form->create(null, array('url' => array('controller' => 'Almacenes', 'action' => 'reporteentregas'))) ?>
        ...
        <div class="six-columns twelve-columns-tablet">
            ...
            <fieldset class="fieldset fields-list">
                ...
                <div class="field-block button-height">
                    ...
                    <span class="input">
                        <span class="icon-calendar"></span>
                        <input type="text" name="data[Persona][fecha2]" id="date" class="input-unstyled datepicker" value="">
                    </span>                  
                </div>
                <div class="field-block button-height">
