    ...
    <div id="areaImprimir">
        ...
        <div class="content-gird">
            <table class="titulos">
                ...
                <th  width="15%"><?php echo $distribuidor; ?></th>
                <th  width="15%">fecha</th>
                <th  width="15%"><?php echo $hoy; ?></th>
                </thead>
            </table>
...
?>
        ...
        <?php endforeach; ?>
                ...
                <div>
                    <?php //echo $this->Form->button('detalle vertical', array('id' =>'btnVertical')) ?>
                </div>
                <div id='vertical'>
...
number_format($v['Ventasdistribuidore']['precio'], 2, '.', ','); ?></td>
                                    <td style="text-align: right"><?php echo
number_format($v['Ventasdistribuidore']['total'], 2, '.', ','); ?></td>
                                <?php $a = 1; ?>
                                </tr>
                        <?php endforeach; ?>
                        </tbody>
...
<?php endif; ?>
    ...
    <div>
        ...
        <a href="<?php echo $this->Html->url(array('action' => 'pidecodigo')) ?>" style="text-align: left; padding: 0 0 0 5px">ATRAS</a>
    </div>
