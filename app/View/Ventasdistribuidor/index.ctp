  ...
  <div class="title-grid"> <span>Ruta <?php echo $ruta['Ruta']['nombreruta'];?> zona: <?php echo $ruta['Ruta']['codigo'];?></span></div>
...
<?php echo $this->Html->link($this->Html->image('cuestionario.png',array('title'=>'Evaluar cliente')), array("controller" => "Confcuestionarios" ,'action'=>'verconfcli',$li['Cliente']['id']), array('escape' => false));?>&nbsp;
        ...
        <script>
          jQuery(document).ready(function() {
            ...
            jQuery("#dialog2").dialog().load('http://localhost/inventario/ventasdistribuidor/ajaxobs/<?php echo $li['Cliente']['id'];?>');
            });
