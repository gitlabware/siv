            ...
            <table  id="sorting-example2">
                ...
                <?php if (!empty($ventas)): ?>
                    ...
                    foreach ($clientes as $c):
                        ?>
                        <tr>
                            <th scope="row" style="font: 8px;">
                            <?php echo $c['Cliente']['num_registro']; ?>
                            <br/>
                            <small style="font: 5px; !important;"><?php echo $c['Cliente']['nombre']; ?></small>
                            </th>
                            ...
                            foreach ($precios as $p):
                                ?>
                                <?php
                                $ventacliente = $venta->find('first', array(
                                    'conditions' => array(
                                ...
                                <td>
                                    <?php if (!empty($ventacliente)): ?>
                                        <?php
                                        echo $ventacliente['Ventasdistribuidore']['cantidad'];
                                        $subtotal += $ventacliente['Ventasdistribuidore']['total'];
                                        ?>
                                    <?php else: ?>
                                        0
                                <?php endif; ?>
